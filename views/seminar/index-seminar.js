$("#responsive-datatable").DataTable({
    ...
    "pageLength": 15,
    "ajax": {
        "url": baseUrl + 'api/seminar/seminar-index',
        "type": "POST"
    },
    // rowGroup: {
    //     startRender: null,
    ...
    "columnDefs": [
        {
            ...
            render: (data, type, row, meta) => {
                ...
                var tr = "<a href='#' onClick='updateSeminar(this)' data-id='" + row[0] + "'  class='btn btn-outline-primary btn-icon btn-md'><span class='fas fa-pencil-alt'></span></a> &nbsp;"
                    + "<a href='#' onClick='hapusData(this)' data-status='" + row[5] + "' data-value='" + row[0] + "' class='btn btn-outline-danger btn-icon btn-md'><span class='fas fa-trash'></span></a> &nbsp;"
                return tr;
            }
        },
        {
            "targets": [3],
            render: (data, type, row, meta) => {
                var a = "<a target='_blank' href='" + baseUrl + "/lampiran-seminar/" + row[3] + "' class='btn btn-info btn-sm'>Link Gambar</a>";
                return a;
            }
        },
        //     render: (data, type, row, meta) => {
